...
public enum ProductPriceUtils {
    ...
    public ProductPriceCriteriaDTO getDefaultCriteria() {
        return new ProductPriceCriteriaDTO(DEFAULT_APPLICATION_DATE, DEFAULT_PRODUCT_ID.value(), DEFAULT_BRAND_ID.value());
    }
}
